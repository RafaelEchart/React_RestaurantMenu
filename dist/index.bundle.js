...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popup-window {\n  box-sizing: border-box;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  z-index: 9999;\n  pointer-events: all;\n  opacity: 0;\n  transform: rotate3d(1, 0.5, 0.5, 180deg) scale(0);\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.popup-window--visible {\n  opacity: 1;\n  transform: rotate3d(1, 0.5, 0.5, 0deg) scale(1);\n  transition: all ease-in 0.3s;\n}\n\n.popup-window--hidden {\n  opacity: 0;\n  transform: rotate3d(1, 0.5, 0.5, 180deg) scale(0);\n  transition: all ease-in 0.3s;\n}\n\n.popup-window__content {\n  position: relative;\n  background-color: var(--light-color);\n  border-radius: 0.5rem;\n  padding: 1rem;\n  box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.5);\n  pointer-events: all;\n  overflow-y: scroll;\n}\n\n.popup-window__close {\n  position: absolute;\n  top: 0.5rem;\n  right: 0.5rem;\n  font-size: 1.5rem;\n  color: var(--primary-color);\n  cursor: pointer;\n}\n\n.popup-window .comments-form {\n  gap: 0.5rem;\n}\n\n.popup-window .popup-image {\n  width: 90%;\n  height: auto;\n  max-height: 50vh;\n  object-fit: cover;\n  clear: both;\n}\n", "",{"version":3,"sources":["webpack://./src/styles/popUpWindow.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,eAAe;EACf,MAAM;EACN,OAAO;EACP,YAAY;EACZ,aAAa;EACb,aAAa;EACb,mBAAmB;EACnB,UAAU;EACV,iDAAiD;EACjD,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,UAAU;EACV,+CAA+C;EAC/C,4BAA4B;AAC9B;;AAEA;EACE,UAAU;EACV,iDAAiD;EACjD,4BAA4B;AAC9B;;AAEA;EACE,kBAAkB;EAClB,oCAAoC;EACpC,qBAAqB;EACrB,aAAa;EACb,4CAA4C;EAC5C,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,aAAa;EACb,iBAAiB;EACjB,2BAA2B;EAC3B,eAAe;AACjB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,UAAU;EACV,YAAY;EACZ,gBAAgB;EAChB,iBAAiB;EACjB,WAAW;AACb","sourcesContent":[".popup-window {\n  box-sizing: border-box;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  z-index: 9999;\n  pointer-events: all;\n  opacity: 0;\n  transform: rotate3d(1, 0.5, 0.5, 180deg) scale(0);\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n\n.popup-window--visible {\n  opacity: 1;\n  transform: rotate3d(1, 0.5, 0.5, 0deg) scale(1);\n  transition: all ease-in 0.3s;\n}\n\n.popup-window--hidden {\n  opacity: 0;\n  transform: rotate3d(1, 0.5, 0.5, 180deg) scale(0);\n  transition: all ease-in 0.3s;\n}\n\n.popup-window__content {\n  position: relative;\n  background-color: var(--light-color);\n  border-radius: 0.5rem;\n  padding: 1rem;\n  box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.5);\n  pointer-events: all;\n  overflow-y: scroll;\n}\n\n.popup-window__close {\n  position: absolute;\n  top: 0.5rem;\n  right: 0.5rem;\n  font-size: 1.5rem;\n  color: var(--primary-color);\n  cursor: pointer;\n}\n\n.popup-window .comments-form {\n  gap: 0.5rem;\n}\n\n.popup-window .popup-image {\n  width: 90%;\n  height: auto;\n  max-height: 50vh;\n  object-fit: cover;\n  clear: both;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
const setEventListeners = (dishes) => {
  ...
  lodash__WEBPACK_IMPORTED_MODULE_0___default().forEach(SeeCommentsButton, (button) => {
    button.addEventListener('click', (e) => {
      const dish = lodash__WEBPACK_IMPORTED_MODULE_0___default().filter(dishes, (dish) => dish.idMeal === e.target.id);
      (0,_popUpWindow_js__WEBPACK_IMPORTED_MODULE_1__["default"])(dish[0].idMeal);
    });
  });
};
...
/* harmony import */ var _fillCategories__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fillCategories */ "./src/fillCategories.js");
/* harmony import */ var _renderFooter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./renderFooter */ "./src/renderFooter.js");
/* harmony import */ var _getDishesFromCategory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./getDishesFromCategory */ "./src/getDishesFromCategory.js");
...
window.onload = async () => {
  ...
  (0,_renderFooter__WEBPACK_IMPORTED_MODULE_4__["default"])();

  (0,_fillCategories__WEBPACK_IMPORTED_MODULE_3__["default"])(categories);
  (0,_getDishesFromCategory__WEBPACK_IMPORTED_MODULE_5__["default"])(categories, '1');
